# Vectors
#+LATEX_HEADER:    \newcommand{\vectorstyle}[1]{\ensuremath{\symbfit{#1}}}

#+LATEX_HEADER:    \newcommand{\vectorsymstyle}[1]{\ensuremath{\symbfit{#1}}}

#+LATEX_HEADER: \NewDocumentCommand{\vect}{s O{v}}{%
#+LATEX_HEADER:     \IfBooleanTF{#1}
#+LATEX_HEADER:     { \vectorstyle{#2} }
#+LATEX_HEADER:     { \vectorsymstyle{#2} }
#+LATEX_HEADER: }%
