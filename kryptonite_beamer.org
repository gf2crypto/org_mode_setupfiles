...
#+LATEX_HEADER_EXTRA: {
#+LATEX_HEADER_EXTRA: \vspace*{3\baselineskip}
#+LATEX_HEADER_EXTRA:   \begin{beamercolorbox}[wd=0.7\paperwidth, ht=0.5\paperheight]{}
#+LATEX_HEADER_EXTRA:
#+LATEX_HEADER_EXTRA:   \addtolength{\leftskip}{10pt}
#+LATEX_HEADER_EXTRA:    %\vskip0pt plus 1filll
...
#+LATEX_HEADER_EXTRA: \bigskip
#+LATEX_HEADER_EXTRA: \usebeamerfont{date}\insertdate\par
#+LATEX_HEADER_EXTRA: \end{beamercolorbox}
#+LATEX_HEADER_EXTRA: %\vspace*{\fill}
#+LATEX_HEADER_EXTRA:
#+LATEX_HEADER_EXTRA:  \vskip0pt plus 1fill
#+LATEX_HEADER_EXTRA:  %\vspace*{2\baselineskip}
