...
#+LATEX_HEADER_EXTRA: \definecolor{blue}{RGB}{64,31,202}
...
#+LATEX_HEADER_EXTRA: \setbeamercolor{structure}{fg=darkblue}
...
#+LATEX_HEADER_EXTRA:    \includegraphics[width=1.1\paperwidth, height=53pt]{kryptonite_title_frame.png}
