...
#+LATEX_HEADER_EXTRA: \newcommand{\headerskipamount}{10\bigskipamount}
#+LATEX_HEADER_EXTRA: \newcommand{\titleskipamount}{5\bigskipamount}
#+LATEX_HEADER_EXTRA: \newcommand{\signedbyskipamount}{5\bigskipamount}
#+LATEX_HEADER_EXTRA: \newcommand{\signedbyinternalskipamount}{\smallskipamount}
#+LATEX_HEADER_EXTRA: \newcommand{\dateskipamount}{\smallskipamount}

#+LATEX_HEADER_EXTRA: \newcommand{\headertitleskip}[1]{\renewcommand{\headerskipamount}{#1}}
#+LATEX_HEADER_EXTRA: \newcommand{\titletextskip}[1]{\renewcommand{\titleskipamount}{#1}}
#+LATEX_HEADER_EXTRA: \newcommand{\textsignskip}[1]{\renewcommand{\signedbyskipamount}{#1}}
#+LATEX_HEADER_EXTRA: \newcommand{\signdateskip}[1]{\renewcommand{\dateskipamount}{#1}}



#+LATEX_HEADER_EXTRA: \newcommand*{\signedby}[3][]{  % insert signature
#+LATEX_HEADER_EXTRA:   \par\noindent
#+LATEX_HEADER_EXTRA:   \vspace{\signedbyskipamount}%
...
#+LATEX_HEADER_EXTRA: \AtEndDocument{\vspace{\dateskipamount}\printdate[\UseName{@date}]}
...
#+LATEX_HEADER_EXTRA: \printheader{\UseName{@subtitle}}%\par
#+LATEX_HEADER_EXTRA: \vspace{\headerskipamount}%
...
#+LATEX_HEADER_EXTRA: %\par%
#+LATEX_HEADER_EXTRA: \vspace{\titleskipamount}%
#+LATEX_HEADER_EXTRA: }
