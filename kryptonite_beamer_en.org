...
#+LATEX_HEADER_EXTRA:         ]{kryptonite_transition_frame_eng.png};
#+LATEX_HEADER_EXTRA:   }
...
#+LATEX_HEADER_EXTRA:    \includegraphics[width=1.1\paperwidth, height=35pt]{kryptonite_title_frame_eng.png}
...
#+LATEX_HEADER_EXTRA:    \includegraphics[width=50pt]{kryptonite_logo_eng.png}
#+LATEX_HEADER_EXTRA:  \end{textblock*}
#+LATEX_HEADER_EXTRA:}
...
#+LATEX_HEADER_EXTRA:         \includegraphics[height=\paperheight
#+LATEX_HEADER_EXTRA:         ]{title_page_kryptonite_eng.png};
