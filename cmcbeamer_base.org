...
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block title}{fg=black, bg=green}
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block body}{fg=black, bg=green!5}
#+LATEX_HEADER_EXTRA: }

#+LATEX_HEADER_EXTRA: \BeforeBeginEnvironment{theorem}{
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block title}{fg=black, bg=red}
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block body}{fg=black, bg=red!5}
#+LATEX_HEADER_EXTRA: }
#+LATEX_HEADER_EXTRA: \BeforeBeginEnvironment{theorem*}{
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block title}{fg=black, bg=red}
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block body}{fg=black, bg=red!5}
...
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block title}{fg=black, bg=blue}
#+LATEX_HEADER_EXTRA:   \setbeamercolor{block body}{fg=black, bg=blue!5}
#+LATEX_HEADER_EXTRA: }
